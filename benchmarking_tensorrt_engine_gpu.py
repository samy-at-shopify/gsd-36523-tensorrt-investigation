...
images_per_batch = 10
image_shape = (384, 384, 3)
min_input_shape = (images_per_batch, *image_shape)
opt_input_shape = (images_per_batch, *image_shape)
max_input_shape = (images_per_batch, *image_shape)
np.random.seed(42)
...
out = run_inference(engine,input_image)
